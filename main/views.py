...
def contact(request):
    if request.method == "POST":
        ...
        subject_admin = f"New Contact Form Submission - Voiage Hub"
        message_admin = f"""
Name: {full_name}
Email: {email}
Interested In: {interested_in}
Message: {message}
"""  # Removed 'Company: Voiage Hub' line for admin

        subject_user = f"Thank you for contacting Voiage Hub"
        message_user = f"""
Hi {full_name},

Thank you for reaching out to Voiage Hub! We received your message:
